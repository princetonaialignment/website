...
const Navbar: FC = () => {
  ...
  const navItems = ["About", "Activities", "Community", "Papers", "Contact"];
            ...
            <AnimatePresence mode="wait">
              {!scrolled ? (
                <motion.span
                  ...
                  exit={{ opacity: 0, y: -5 }}
                  className="text-white font-bold text-sm sm:text-base lg:text-lg transition-all duration-300 ease-in-out"
                >
                  {fullText}
                </motion.span>
              ) : (
